...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::post('/places/{place}', [PlaceController::class, 'update']);   // _method=PUT
    Route::delete('/places/{place}', [PlaceController::class, 'destroy']);

    // Menus CRUD
    Route::post('/places/{place}/menus', [MenuController::class, 'store']);
    Route::post('/menus/{menu}',         [MenuController::class, 'update']); // _method=PUT
    ...
    // Profile
    Route::post('/users/{username}', [UserController::class, 'update']); // _method=PUT
});
