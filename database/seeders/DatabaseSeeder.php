...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $user1 = User::firstOrCreate(['email' => 'foodie@example.com'], [
            ...
            'bio'      => 'Pecinta kuliner Malang 🍜 | Selalu hunting tempat baru!',
        ]);
        ...
        $p1 = Place::firstOrCreate(['name' => 'Warung Soto Lamongan Pak Dhe'], [
            'user_id'     => $user1->id,
            'bio'         => 'Soto lamongan otentik dengan kuah bening yang segar, sudah berdiri sejak 1985.',
            'types'       => ['makan'],
            'lokasi'      => 'merjosari',
        ...
        $p1->categories()->syncWithoutDetaching([$warung->id]);

        $p2 = Place::firstOrCreate(['name' => 'Kedai Kopi Omah Susu'], [
            'user_id'     => $user2->id,
            'bio'         => 'Kedai kopi cozy dengan konsep rumah vintage. Kopi susu gula aren yang bikin nagih!',
            'types'       => ['minum'],
            'lokasi'      => 'dinoyo',
        ...
        $p2->categories()->syncWithoutDetaching([$kafe->id]);

        $p3 = Place::firstOrCreate(['name' => 'Boba Frenzy Malang'], [
            'user_id'     => $user1->id,
            'bio'         => 'Boba kekinian dengan topping lengkap, level manis bisa custom!',
            'types'       => ['minum'],
            'lokasi'      => 'watugong',
        ...
        $p3->categories()->syncWithoutDetaching([$boba->id]);
